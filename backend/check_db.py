...
# PDF가 잘 쪼개지고 백터로 변환되어 DB에 들어갔는지 확인하기 위한 코드
# DB 접속 -> 특정 컬렉션 찾기 -> 컬레션 안의 문서 내용 확인
...
COLLECTION_NAME = "homepage_pdfplumner_1st" # 확인하고 싶은 컬렉션 이름
...
try:
    ...
    if not result:
        ...
        # 2. 해당 collection_uuid를 가진 문서(청크) 조회
